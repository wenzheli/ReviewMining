...
public class NGramModel {
    ...
    private short [][][] nTopicPrevWordWord; //nTopicWordWord[i][j][k]:  total number of word/term k, assigned to topic i, on the condition that the previous
    ...
    public void init(Options options, DataSet dataset){
        ...
        nWordsSum = new int[D];
        nTopicPrevWordWord = new short[K][V+1][V];
